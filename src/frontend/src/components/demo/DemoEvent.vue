            ...
            <v-timeline align="start" side="end">
              ...
              >
                  ...
                  <v-btn  style="height: 55px; overflow: hidden; max-width: 100%;" @click="eventClicked(item.title)">
                      <strong class="me-4">{{ convertTo12HourFormat(item.time) }}</strong>
                      <div>
          ...
          >
            <div>
              ...
              <div class="text-h5 font-weight-medium mb-2">
                You are looking at a demo event!!
              </div>

              <p class="text-body-2 mb-4">
                This is where important notifications would show for this particular event
              </p>

              <v-btn color="orange" variant="text">Go to Actionable Task</v-btn>
            </div>
          </v-sheet>
        </v-col>
      </v-row>
...
import CreateDemoTimeItem from "@/components/demo/CreateDemoTimeItem.vue";
