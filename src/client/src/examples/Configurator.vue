...
// state
const isRTL = computed(() => argonState.isRTL);
const isNavFixed = computed(() => argonState.isNavFixed);
const sidebarType = computed(() => argonState.sidebarType);
const toggleConfigurator = () => store.commit("argon/toggleConfigurator");

// mutations
const navbarFixed = () => store.commit("argon/navbarFixed");
const setSidebarType = (type) => store.commit("argon/sidebarType", type);
...
const darkMode = () => {
  if (argonState.darkMode) {
    argonState.darkMode = false;
    setSidebarType("bg-white");
    deactivateDarkMode();
    return;
  } else {
    argonState.darkMode = true;
