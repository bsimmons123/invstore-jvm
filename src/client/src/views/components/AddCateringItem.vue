...
<template>
  <div class="modal fade" id="addCateringItemModal" style="" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
